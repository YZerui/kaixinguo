...
public class CustomBtnView extends LinearLayout {
	...
	public CustomBtnView(Context context, AttributeSet attrs) {
		...
		for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.CustomBtnView_btn_color_style) {
            ...
            } else if (attr == R.styleable.CustomBtnView_btn_top_splitline_visible) {
                resourceId = typedArray.getInt(
            ...
            } else if (attr == R.styleable.CustomBtnView_btn_bottom_splitline_visible) {
                resourceId = typedArray.getInt(
            ...
            } else if (attr == R.styleable.CustomBtnView_btn_text) {
            ...
            } else if (attr == R.styleable.CustomBtnView_btn_img) {
            ...
            } else if (attr == R.styleable.CustomBtnView_btn_text_size) {
