...
public class CustomItemView extends LinearLayout {
	...
	public CustomItemView(Context context, AttributeSet attrs) {
		...
		for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.CustomItemView_item_imgRightNote) {
            ...
            } else if (attr == R.styleable.CustomItemView_item_itemHight) {
                ...
                totalLayout.setLayoutParams(new LayoutParams(
                        LayoutParams.FILL_PARENT, height));

            } else if (attr == R.styleable.CustomItemView_item_splitBottomShow) {
            ...
            } else if (attr == R.styleable.CustomItemView_item_splitPartBottomShow) {
                resourceId = typedArray.getInt(
            ...
            } else if (attr == R.styleable.CustomItemView_item_splitTopShow) {
                resourceId = typedArray.getInt(
            ...
            } else if (attr == R.styleable.CustomItemView_item_textContent) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomItemView_item_textNote) {
            ...
            } else if (attr == R.styleable.CustomItemView_item_imgNote) {
            ...
            } else if (attr == R.styleable.CustomItemView_item_text_mode) {
            ...
            } else if (attr == R.styleable.CustomItemView_item_line_mode) {
                normalLayout.setVisibility(View.INVISIBLE);
            ...
            } else if (attr == R.styleable.CustomItemView_item_slipButtonShow) {
                resourceId = typedArray.getInt(
            ...
            } else if (attr == R.styleable.CustomItemView_item_rightNoteShow) {
                resourceId = typedArray.getInt(
            ...
            } else if (attr == R.styleable.CustomItemView_item_rightNoteIconShow) {
                resourceId = typedArray.getInt(
            ...
            } else if (attr == R.styleable.CustomItemView_item_rightNoteTextShow) {
                resourceId = typedArray.getInt(
            ...
            } else if (attr == R.styleable.CustomItemView_item_rightNoteText) {
                rightNoteText.setVisibility(View.VISIBLE);
                imgRightNote.setVisibility(View.VISIBLE);
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomItemView_item_rightNoteIcon) {
                rightNoteIcon.setVisibility(View.VISIBLE);
                imgRightNote.setVisibility(View.VISIBLE);
                resourceId = typedArray.getResourceId(
