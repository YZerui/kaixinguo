...
public class CustomSectorView extends LinearLayout {
	...
	public CustomSectorView(Context context, AttributeSet attrs) {
		...
		for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.CustomSectorView_sector_bottom_visible) {
            ...
            } else if (attr == R.styleable.CustomSectorView_sector_top_visible) {
                resourceId = typedArray.getInt(
            ...
            } else if (attr == R.styleable.CustomSectorView_sector_unit_num) {
                resourceId = typedArray.getInt(
            ...
            } else if (attr == R.styleable.CustomSectorView_sector_first_text) {
            ...
            } else if (attr == R.styleable.CustomSectorView_sector_second_text) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomSectorView_sector_third_text) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomSectorView_sector_fourth_text) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomSectorView_sector_fifth_text) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomSectorView_sector_sixth_text) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomSectorView_sector_top_text) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomSectorView_sector_bottom_text) {
                resourceId = typedArray.getResourceId(
