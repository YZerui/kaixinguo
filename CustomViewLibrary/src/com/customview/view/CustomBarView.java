...
public class CustomBarView extends LinearLayout {
	...
	public CustomBarView(Context context, AttributeSet attrs) {
		...
		for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.CustomBarView_bar_mode) {
                resourceId = typedArray.getInt(
                        R.styleable.CustomBarView_bar_mode, 0);
                onBarMode(resourceId);

            } else if (attr == R.styleable.CustomBarView_bar_unit_num) {
                resourceId = typedArray.getInt(
                        R.styleable.CustomBarView_bar_unit_num, 0);
                onUnitNum(resourceId);

            } else if (attr == R.styleable.CustomBarView_bar_split_view_visible) {
                resourceId = typedArray.getInt(
                        R.styleable.CustomBarView_bar_split_view_visible, 0);
                onSplitViewVisible(resourceId);

            } else if (attr == R.styleable.CustomBarView_bar_unit_one_text) {
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_two_text) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_three_text) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_four_text) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_five_text) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_one_img) {
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_two_img) {
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_three_img) {
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_four_img) {
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_five_img) {
            ...
            } else if (attr == R.styleable.CustomBarView_bar_t_split_view_visible) {
                resourceId = typedArray.getInt(
                        R.styleable.CustomBarView_bar_t_split_view_visible, 0);
                onTSplitVisible(resourceId);

            } else if (attr == R.styleable.CustomBarView_bar_b_split_view_visible) {
                resourceId = typedArray.getInt(
                        R.styleable.CustomBarView_bar_b_split_view_visible, 0);
                onBSplitVisible(resourceId);

            } else if (attr == R.styleable.CustomBarView_bar_text_color) {
            ...
            } else if (attr == R.styleable.CustomBarView_bar_h_item_heigth) {
            ...
            } else if (attr == R.styleable.CustomBarView_bar_v_item_heigth) {
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_one_bg) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_two_bg) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_three_bg) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_four_bg) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomBarView_bar_unit_five_bg) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomBarView_bar_img_size) {
