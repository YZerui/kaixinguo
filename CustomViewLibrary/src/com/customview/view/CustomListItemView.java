...
//		titleRightText2=(TextView)view.findViewById(R.id.fixDouble_title_right_2);
		...
		for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.CustomListItemView_list_item_height) {
...
//
//				break;
            } else if (attr == R.styleable.CustomListItemView_LIST_ITEM_MODE) {
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_unfix_icon) {
                resourceId = typedArray.getResourceId(
                        R.styleable.CustomListItemView_list_item_unfix_icon, 0);
                unFix_icon.setImageResource(resourceId > 0 ? resourceId
                        : R.drawable.app_icon);

            } else if (attr == R.styleable.CustomListItemView_list_item_unfix_content) {
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_unfix_timer) {
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_unfix_title) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_fix_double_content) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_fix_double_timer) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_fix_double_title) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_fix_icon) {
                resourceId = typedArray.getResourceId(
                        R.styleable.CustomListItemView_list_item_fix_icon, 0);
                fix_icon.setImageResource(resourceId > 0 ? resourceId
                        : R.drawable.app_icon);

            } else if (attr == R.styleable.CustomListItemView_list_item_fix_single_title) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_more_note_icon) {
                resourceId = typedArray
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_checkbox_download_file) {
                resourceId = typedArray
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_fixLayout_bg) {
                resourceId = typedArray.getResourceId(
                        R.styleable.CustomListItemView_list_item_fixLayout_bg,
                        0);
                fixItem.setBackgroundResource(resourceId);

            } else if (attr == R.styleable.CustomListItemView_list_item_unFixLlayout_bg) {// resourceId = typedArray
                // .getResourceId(
                // R.styleable.CustomListItemView_list_item_unFixLlayout_bg,
                // 0);
                // unFixItem.setBackgroundResource(resourceId);

            } else if (attr == R.styleable.CustomListItemView_list_item_head_mode) {
                resourceId = typedArray.getInt(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_checkbox_select) {
                resourceId = typedArray
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_note_text_visible) {
                resourceId = typedArray
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_right_note_text) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_note_text_color) {
                resourceId = typedArray
                ...
                //底部bar单元数
            } else if (attr == R.styleable.CustomListItemView_list_item_bottom_unit_num) {
                resourceId = typedArray
                        .getInt(R.styleable.CustomListItemView_list_item_bottom_unit_num,
                                0);
                bottomBar.onUnitNum(resourceId).setVisibility(View.VISIBLE);

            } else if (attr == R.styleable.CustomListItemView_list_item_bottom_visible) {
                resourceId = typedArray
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_bottom_unit_img_1) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_bottom_unit_img_2) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_bottom_unit_img_3) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_bottom_unit_img_4) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_bottom_unit_text_1) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_bottom_unit_text_2) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_bottom_unit_text_3) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_bottom_unit_text_4) {
                resourceId = typedArray
                        .getResourceId(
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_fix_split_line) {
                resourceId = typedArray
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_bottom_split_line) {
                resourceId = typedArray
            ...
            } else if (attr == R.styleable.CustomListItemView_list_item_content_clickable) {//是否可触发
                resourceId = typedArray.getInt(
