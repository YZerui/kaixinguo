...
public class CustomTopbarView extends LinearLayout {
	...
	private TextView backText, title,title_vice, leftTextBtn, rightTextBtn,
	...
	public CustomTopbarView(Context context, AttributeSet attrs) {
		...
		title_vice = (TextView) view.findViewById(R.id.topbar_title_vice);
		...
		noteLayout=(RelativeLayout) view.findViewById(R.id.noteLayout);
		...
		for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.CustomTopBarView_topbar_bg_color) {
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_height) {
                height = typedArray.getDimension(
                        R.styleable.CustomTopBarView_topbar_height, 45);
                topbarLayout.setLayoutParams(new LayoutParams(
                        LayoutParams.FILL_PARENT, (int) height));

            } else if (attr == R.styleable.CustomTopBarView_topbar_back_text) {// backText.setVisibility(View.VISIBLE);
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_back_visibility) {
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_left_btn_visibility) {
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_left_img_src) {
                leftBtn.setVisibility(View.VISIBLE);
                // backLayout.setVisibility(View.VISIBLE);
                resourceId = typedArray.getResourceId(
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_left_text) {// leftBtn.setVisibility(View.VISIBLE);
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_left_text_btn_visibility) {
                resourceId = typedArray
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_progress_visibility) {
                resourceId = typedArray
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_right_btn_visibility) {
                resourceId = typedArray
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_right_img_src) {
                rightBtn.setVisibility(View.VISIBLE);
                resourceId = typedArray.getResourceId(
                        R.styleable.CustomTopBarView_topbar_right_img_src, 0);
                rightBtn.setImageResource(resourceId);

            } else if (attr == R.styleable.CustomTopBarView_topbar_right_text) {
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_right_text_btn_visibility) {
                resourceId = typedArray
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_title) {
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_title_color) {
                resourceId = typedArray.getColor(
                        R.styleable.CustomTopBarView_topbar_title_color,
                        bgColor);
                title.setTextColor(resourceId);

            } else if (attr == R.styleable.CustomTopBarView_topbar_text_color) {
                resourceId = typedArray
                        .getColor(
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_right_second_btn) {// 右边第二个按钮控件(相对按钮控件而言)
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_right_second_btn_text) {// 右边第二个按钮控件(相对文本控件而言)
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_right_second_text_btn) {// 右边第二个文本控件(相对按钮控件而言)|
                splitSecondLine_Btn.setVisibility(View.VISIBLE);
            ...
            } else if (attr == R.styleable.CustomTopBarView_topbar_right_second_text_btn_text) {// 右边第二个文本控件(相对文本控件而言)
                splitSecondLine_Text.setVisibility(View.VISIBLE);
	...
	public CustomTopbarView setViceTitle(String str){
		title_vice.setVisibility(View.VISIBLE);
		title_vice.setText(str);
		return this;
	}
	public CustomTopbarView setViceTitleVisibility(boolean visible){
		if(visible){
			title_vice.setVisibility(View.VISIBLE);
		}else {
			title_vice.setVisibility(View.INVISIBLE);
		}
		return this;
	}
	/**
	...
	public CustomTopbarView onNoteText(String text){
		noteLayout.setVisibility(View.VISIBLE);
		noteText.setVisibility(View.VISIBLE);
		noteText.setText(text);
		onTopToDownAnimator(noteLayout);
		onDownToTopAnimator(noteLayout, 4000);
		return this;
	}
	
	private void onTopToDownAnimator(View view){
		ObjectAnimator animatorTrans=ObjectAnimator.ofFloat(view, "translationY",-400f,0f);
		ObjectAnimator animatorAlpha=ObjectAnimator.ofFloat(view, "alpha",0.5f,1f);
		AnimatorSet set = new AnimatorSet();
		set.play(animatorTrans).with(animatorAlpha);
		set.setDuration(800).start();
	}
	private void onDownToTopAnimator(View view,long delay){
		ObjectAnimator animatorTrans=ObjectAnimator.ofFloat(view, "translationY",0f,-400f);
		ObjectAnimator animatorAlpha=ObjectAnimator.ofFloat(view, "alpha",1f,0.5f);
		AnimatorSet set = new AnimatorSet();
		set.play(animatorTrans).with(animatorAlpha);
