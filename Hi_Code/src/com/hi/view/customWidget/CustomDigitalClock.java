...
public class CustomDigitalClock extends DigitalClock {
	 ...
	 * @return
	 */
	public static String dealTime(long time, Enum_TimerType mode) {
		...
		case TIMER_HOUR:
			...
			break;
		case TIMER_HOUR_MINUTE:
			returnString.append(hoursStr).append(":").append(minutesStr);
			break;
		case TIMER_MINUTE:
			returnString.append(minutesStr);
			break;
		case TIMER_MINUTE_SECOND:
	 ...
	 * @param endTime
	 */
	public void setEndTime(long endTime,Enum_TimerType mode,String noteText) {
