...
public class TitlePopup extends PopupWindow {
	...
	public TitlePopup(Context context) {
		// 设置布局的参数
		this(context, LayoutParams.WRAP_CONTENT);
	}

	public TitlePopup(Context context,int height) {
	...
	public void show(View view) {
		...
		System.out.println("location:"+mLocation[0]);
		System.out.println("screen width:"+mScreenWidth/2);
