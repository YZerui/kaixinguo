 ...
 */
package com.hi.utils.imgLoadUtil;
...
public class DiskLruCache {
	...
	/**
	 * Constructor that should not be called directly, instead use {@link com.hi.utils.imgLoadUtil.DiskLruCache#openCache(android.content.Context, java.io.File, long)} which runs some extra checks before creating a DiskLruCache
	 * instance.
	 * 
	 * @param cacheDir
	 * @param maxByteSize
	...
	/**
	 * Removes all disk cache entries from the given directory. This should not be called directly, call {@link com.hi.utils.imgLoadUtil.DiskLruCache#clearCache(android.content.Context, String)} or
	 * {@link com.hi.utils.imgLoadUtil.DiskLruCache#clearCache()} instead.
	 * 
	 * @param cacheDir
	...
	/**
	 * Writes a bitmap to a file. Call {@link com.hi.utils.imgLoadUtil.DiskLruCache#setCompressParams(android.graphics.Bitmap.CompressFormat, int)} first to set the target bitmap compression and format.
	 * 
	 * @param bitmap
	 * @param file
	 * @return
