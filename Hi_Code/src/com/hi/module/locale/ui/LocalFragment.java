 ...
 * 
 */
public class LocalFragment extends Fragment implements OnCheckedChangeListener,
	...
	private void initView() {
		...
		mViewPager = (ViewPager) totalView.findViewById(R.id.local_pager);
		mRadioGroup = (RadioGroup) totalView.findViewById(R.id.local_radio);
		userRadio = (RadioButton) totalView.findViewById(R.id.local_user_radio);
		noteRadio = (RadioButton) totalView.findViewById(R.id.local_note_radio);
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		case R.id.local_user_radio:
			...
			noteRadio.setTextColor(getResources().getColor(R.color.white));
		...
		case R.id.local_note_radio:
			...
			noteRadio.setTextColor(getResources().getColor(
					R.color.app_theme_color));
			userRadio.setTextColor(getResources().getColor(R.color.white));
