...
//
//        // 成功收到消息
//        public void onIMRecvMessage(IMMessage msgBean);

        public boolean onMessageUpdate(String fromID,T_IMsg msgBean);
//        // 消息发送失败
//        public void onIMFail();
    ...
    public static void setSessionPaused(boolean sessionPaused) {
        IMessageReceiver.sessionPaused = sessionPaused;
    }
    ...
    public void onMessage(Context context, Session session, AVMessage msg) {
        ...
        ChatService.onMessage(context,msg,msgListeners);
...
//        }
        ...
        ChatService.onMessageSent(msg,msgListeners);
    }
...
//            // TODO: handle exception
//        }
        ChatService.onMessageFail(msg,msgListeners);
    }
...
//    }
    ...
    public static Set<MessageListener> msgListeners = new HashSet<>();
