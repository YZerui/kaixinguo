...
//		.showStubImage(R.drawable.app_icon)
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.storeName.setText(bean.getTitle()==null?"未知优惠":bean.getTitle());
		holder.privilegeDetail.setText(bean.getContent()==null?"优惠详情":bean.getContent());
		holder.privilegeTitle.setText(bean.getRemark()==null?"未知惊喜":bean.getRemark());
